...
\newcommand{\firstname}{FIRST\_NAME}
\newcommand{\lastname}{LAST\_NAME}
...
\userInfo{ADDRESS}{COUNTRY}{PHONE\_NUMBER}{EMAIL}
\companyInfo{COMPANY\_NAME}{}{}{}
\object{Interest in TITLE Position}
\content{
  Dear Recruiter, \\
  INSERT\_TEXT\_HERE
